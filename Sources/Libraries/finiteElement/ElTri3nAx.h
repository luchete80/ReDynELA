...
#ifndef __ElTri3nAx_h__
#define __ElTri3nAx_h__

#define Name_ElTri3nAx "ElTri3nAx"
...
class ElTri3nAx : public ElementAx
{
...
public:
  /* constructeurs */
  ElTri3nAx(Indice No_ = 1);
  ElTri3nAx(const ElTri3nAx &el);
  ~ElTri3nAx();
